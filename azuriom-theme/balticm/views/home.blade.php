...
html,body{margin:0;padding:0;background:#02050b;color:#fff;font-family:Arial,Helvetica,sans-serif}
body{overflow-x:hidden}
.bm{min-height:100vh;background:#02050b}
.bm-header{height:72px;background:#02050b;display:flex;align-items:center}
...
.bm-logo-text small{display:block;margin-top:3px;color:#77849a;font-size:7px;letter-spacing:.2em}
.bm-links{display:flex;gap:28px;margin-left:auto;margin-right:38px}
.bm-links a{color:#c3ccd9;text-decoration:none;font-size:11px}
.bm-links a:hover{color:#fff}
.bm-actions{display:flex;gap:8px;align-items:center}
.bm-action{width:36px;height:36px;border:1px solid #18283c;border-radius:9px;background:#050b14;color:#dce5f1;display:grid;place-items:center;text-decoration:none}
...
.bm-hero{height:560px;background:#02050b url('{{ theme_asset('balticm-background-web.webp') }}') center center/cover no-repeat;position:relative;display:flex;align-items:center}
.bm-hero::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(2,5,11,.62),rgba(2,5,11,.12) 65%,rgba(2,5,11,.18));pointer-events:none}
...
.bm-subtitle{margin:16px 0 0;max-width:560px;color:#d3dbe6;font-size:13px;line-height:1.6}
.bm-content{background:#02050b;padding:0 0 50px}
.bm-stats{position:relative;margin-top:-42px;display:grid;grid-template-columns:repeat(4,1fr);background:#07101c;border:1px solid #18283c;border-radius:13px;overflow:hidden}
.bm-stat{padding:21px 23px;border-right:1px solid #18283c}
.bm-stat:last-child{border-right:0}
.bm-stat strong{font-size:20px}
.bm-stat small{display:block;margin-top:7px;color:#718097;font-size:7px;letter-spacing:.16em;text-transform:uppercase}
.bm-news{padding-top:18px}
.bm-news-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}
.bm-card{min-height:110px;border:1px solid #18283c;border-radius:11px;background:#050b14;padding:16px;color:#fff;text-decoration:none}
.bm-card:hover{border-color:#2b6fc1}
.bm-card-label{color:#4da8ff;font-size:8px;font-weight:800;letter-spacing:.15em}
.bm-card-date{float:right;color:#637187;font-size:8px}
.bm-card h3{margin:14px 0 7px;font-size:14px}
.bm-card p{margin:0;color:#8290a4;font-size:10px;line-height:1.45}
.bm-empty{border:1px dashed #18283c;border-radius:11px;padding:20px;color:#738197;font-size:10px}
.bm-footer{background:#02050b;border-top:1px solid #0d1724;padding:28px 0}
...
.bm-footer-brand small{display:block;margin-top:4px;color:#59677b;font-size:7px;letter-spacing:.2em}
.bm-footer-links{display:flex;gap:20px}
.bm-footer-links a{color:#7d8b9e;text-decoration:none;font-size:9px}
.bm-footer-social{display:flex;gap:8px}
.bm-footer-social a{width:32px;height:32px;border:1px solid #18283c;border-radius:8px;display:grid;place-items:center;color:#b7c4d5;text-decoration:none}
@media(max-width:900px){.bm-links{display:none}.bm-inner{width:calc(100% - 32px)}.bm-hero{height:540px}.bm-title{font-size:66px}.bm-stats{grid-template-columns:1fr 1fr}.bm-stat:nth-child(2){border-right:0}.bm-stat:nth-child(-n+2){border-bottom:1px solid #18283c}.bm-news-grid{grid-template-columns:1fr}.bm-footer-row{align-items:flex-start;flex-direction:column}}
