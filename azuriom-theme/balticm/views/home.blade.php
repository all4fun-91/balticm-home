...
.bm-home__header{height:72px;background:#02050b;border:0;position:relative;z-index:50}
...
/* The artwork is clipped, never covered by a fake overlay. */
.bm-home__visual{position:relative;height:540px;overflow:hidden;background:#02050b}
.bm-home__visual img{position:absolute;left:0;top:1px;width:100%;height:calc(100% - 2px);display:block;object-fit:cover;object-position:center top;clip-path:inset(0 0 0 0)}
...
.bm-home__footer{border:0;background:#02050b}
