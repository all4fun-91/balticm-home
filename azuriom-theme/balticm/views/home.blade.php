...
html,body{margin:0;padding:0;background:transparent;color:#fff;font-family:Arial,Helvetica,sans-serif}
body{overflow-x:hidden}
.bm{min-height:100vh;background:transparent}
.bm-header{height:72px;background:transparent;display:flex;align-items:center}
...
.bm-logo-text small{display:block;margin-top:3px;color:#ddd;font-size:7px;letter-spacing:.2em}
.bm-links{display:flex;gap:28px;margin-left:auto;margin-right:38px}
.bm-links a{color:#fff;text-decoration:none;font-size:11px}
.bm-links a:hover{color:#2997ff}
.bm-actions{display:flex;gap:8px;align-items:center}
.bm-action{width:36px;height:36px;border:0;border-radius:9px;background:transparent;color:#fff;display:grid;place-items:center;text-decoration:none}
.bm-action:hover{color:#2997ff}
...
.bm-hero{height:560px;background:transparent url('{{ theme_asset('balticm-background-web.webp') }}') center center/cover no-repeat;position:relative;display:flex;align-items:center}
.bm-hero::after{display:none}
...
.bm-subtitle{margin:16px 0 0;max-width:560px;color:#fff;font-size:13px;line-height:1.6}
.bm-content{background:transparent;padding:0 0 50px}
.bm-stats{position:relative;margin-top:-42px;display:grid;grid-template-columns:repeat(4,1fr);background:transparent;border:0;border-radius:0;overflow:visible}
.bm-stat{padding:21px 23px;border:0}
.bm-stat strong{font-size:20px}
.bm-stat small{display:block;margin-top:7px;color:#fff;font-size:7px;letter-spacing:.16em;text-transform:uppercase}
.bm-news{padding-top:18px}
.bm-news-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}
.bm-card{min-height:110px;border:0;border-radius:0;background:transparent;padding:16px;color:#fff;text-decoration:none}
.bm-card:hover{background:rgba(255,255,255,.04)}
.bm-card-label{color:#59aaff;font-size:8px;font-weight:800;letter-spacing:.15em}
.bm-card-date{float:right;color:#fff;font-size:8px}
.bm-card h3{margin:14px 0 7px;font-size:14px}
.bm-card p{margin:0;color:#fff;font-size:10px;line-height:1.45}
.bm-empty{border:0;border-radius:0;padding:20px;color:#fff;font-size:10px;background:transparent}
.bm-footer{background:transparent;border:0;padding:28px 0}
...
.bm-footer-brand small{display:block;margin-top:4px;color:#fff;font-size:7px;letter-spacing:.2em}
.bm-footer-links{display:flex;gap:20px}
.bm-footer-links a{color:#fff;text-decoration:none;font-size:9px}
.bm-footer-links a:hover{color:#2997ff}
.bm-footer-social{display:flex;gap:8px}
.bm-footer-social a{width:32px;height:32px;border:0;border-radius:8px;display:grid;place-items:center;color:#fff;text-decoration:none}
.bm-footer-social a:hover{color:#2997ff}
@media(max-width:900px){.bm-links{display:none}.bm-inner{width:calc(100% - 32px)}.bm-hero{height:540px}.bm-title{font-size:66px}.bm-stats{grid-template-columns:1fr 1fr}.bm-stat:nth-child(2){border-right:0}.bm-news-grid{grid-template-columns:1fr}.bm-footer-row{align-items:flex-start;flex-direction:column}}
